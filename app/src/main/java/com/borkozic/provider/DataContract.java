...
{
	public static final String AUTHORITY = "com.borkozic.DataProvider";
	public static final String ACTION_PICK_ICON = "com.borkozic.PICK_ICON";
	public static final String ACTION_PICK_MARKER = "com.borkozic.PICK_MARKER";
